...
const LoginForm: React.FC<{ onLogin: () => void }> = ({ onLogin }) => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "linear-gradient(to bottom right, #6a0dad, #b185f1)", // violet to soft lavender
      }}
    >
      <div className="flex flex-col items-center px-4">
        ...
        <form
          ...
          className="bg-white/90 backdrop-blur-md shadow-2xl rounded-2xl p-8 w-full max-w-sm"
        >
